...
def vgg_model(x_train):
  ...
  x = Conv2D(filters=32, kernel_size=(3,3),padding="same",kernel_regularizer=regularizers.l2(weight_decay))(inputs)
  x = Activation(activation="relu")(x)
  x = BatchNormalization()(x)
  x = Conv2D(filters=32, kernel_size=(3,3),padding="same",kernel_regularizer=regularizers.l2(weight_decay))(x)
  x = Activation(activation="relu")(x)
  x = BatchNormalization()(x)
  x = MaxPooling2D(pool_size=(2,2))(x)
  x = Dropout(0.2)(x)
  x = Conv2D(filters=64, kernel_size=(3,3),padding="same",kernel_regularizer=regularizers.l2(weight_decay))(x)
  x = Activation(activation="relu")(x)
  x = BatchNormalization()(x)
  x = Conv2D(filters=64, kernel_size=(3,3),padding="same",kernel_regularizer=regularizers.l2(weight_decay))(x)
  x = Activation(activation="relu")(x)
  ...
  x = MaxPooling2D(pool_size=(2,2))(x)
  x = Dropout(0.3)(x)
  x = Conv2D(filters=128, kernel_size=(3,3),padding="same",kernel_regularizer=regularizers.l2(weight_decay))(x)
  x = Activation(activation="relu")(x)
  x = BatchNormalization()(x)
  x = Conv2D(filters=128, kernel_size=(3,3),padding="same",kernel_regularizer=regularizers.l2(weight_decay))(x)
  x = Activation(activation="relu")(x)
...
filepath="/home/mech/btech/me2160793/COL341/A2_B/"+"weights-improvement_when_learning_schedule.hdf5"
...
model.save_weights(data_dir+'cifar10_normal_rms_ep75.h5')
